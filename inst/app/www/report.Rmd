...
if("verbatim_comments" %in% params$options){
  ...
  cat("Note that in the interests of brevity comments where the assined category
...
if("sample_demographics" %in% params$options){
  ...
  print(demographic_distribution(unique_data, params$demography_1))
  ...
  print(demographic_distribution(unique_data, params$demography_2))
  ...
  print(demographic_distribution(unique_data, params$demography_3))
