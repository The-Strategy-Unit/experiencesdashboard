  ...
  if (!is.null(latest_time)) {
    showModal(modalDialog(
      ...
      HTML(paste(
        ...
        h6(HTML(paste0(
          "A data uploaded at", strong(em((paste(latest_time, "GMT")))), "is still uploading. If you really need to access the most up-to-date data, please check back or reload your browser in roughly",
